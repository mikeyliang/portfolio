...
export default function Card<T extends { toString(): string }>(
  ...
  return (
    <div
      ...
      {props.link && <div className="flex flex-row items-center justify-center gap-1 px-2 py-1 text-xs bg-blue-200 rounded-full hover:bg-blue-300 text-zinc-700"><span>Preview</span><IconEye size={12}/></div>}
      </div>
